...
public class SqlToolsConnection implements Connection,RequestFactorySession {
	...
	@Override
	public <B> void setSaveBeanPreparedStatement(Class<B> beanClass,
			PreparedStatement statement) {
		saveStatements.put(beanClass, statement);
	}
	
	@Override
	public <T> PreparedStatement getUpdateBeanPreparedStatement(
			Class<T> beanClass) {
		return(updateStatements.get(beanClass));
	}

	@Override
	public <T> void setUpdateBeanPreparedStatement(Class<T> beanClass,
			PreparedStatement statement) {
